        ...
        <Overlay info={props.info} galleryType={props.galleryType} handleArrowClick={props.handleArrowClick} handleCloseClick={props.handleCloseClick}/>
          ...
          <div className="row-grid">
            <div className="column-grid">
              ...
              <img src={require("../imgs/illustrations/houseplant.png")} title={props.illustrationsData[0].name} name="illustrations" style={{width:'100%'}} onClick={props.handleImageClick} />
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/illustrations/housegrowth.png")} title={props.illustrationsData[0].name} name="illustrations" style={{width:'100%'}} onClick={props.handleImageClick} />
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/illustrations/deer.png")} title={props.illustrationsData[0].name} name="illustrations" style={{width:'100%'}} onClick={props.handleImageClick} />
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/illustrations/orchids.png")} title={props.illustrationsData[0].name} name="illustrations" style={{width:'100%'}} onClick={props.handleImageClick} />
