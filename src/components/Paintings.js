        ...
        <Overlay info={props.info} galleryType={props.galleryType} handleArrowClick={props.handleArrowClick} handleCloseClick={props.handleCloseClick}/>
          ...
          <div className="row-grid">
            <div className="column-grid">
              <img src={require("../imgs/paintings/Sun-Earth.jpg")} title={props.paintingsData[19].name} style={{width:'100%'}} name="paintings" onClick={props.handleImageClick}/>
              <img src={require("../imgs/paintings/Grace.jpg")} title={props.paintingsData[14].name} name="paintings" style={{width:'100%'}} onClick={props.handleImageClick}/>
            ...
            <div className="column-grid">
              <img src={require("../imgs/paintings/Growth.jpg")} title={props.paintingsData[15].name} style={{width:'100%'}} name="paintings" onClick={props.handleImageClick}/>
            ...
            <div className="column-grid">
              <img src={require("../imgs/paintings/Saturn.jpg")} title={props.paintingsData[18].name} name="paintings" style={{width:'100%'}} onClick={props.handleImageClick}/>
              <img src={require("../imgs/paintings/Hope.jpg")} title={props.paintingsData[16].name} style={{width:'100%'}} name="paintings" onClick={props.handleImageClick}/>
            ...
            <div className="column-grid">
              <img src={require("../imgs/paintings/Up.jpg")} title={props.paintingsData[17].name} name="paintings" style={{width:'100%'}} onClick={props.handleImageClick}/>
