        ...
        <div className="gallery">
          <div className="row-grid">
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/printmaking/explosion.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/IMG_8576.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/Turtle_state12.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/IMG_8578.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/industrialization1.jpg")} style={{width:'100%'}} />
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/printmaking/Flight.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/Ghost-print-of-the-Village.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/IMG_8582.jpg")} style={{width:'100%'}} />
            ...
            <div className="column-grid">
              ...
              <img src={require("../imgs/printmaking/Growing.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/heart-attack1.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/3-color-print1.jpg")} style={{width:'100%'}} />
              <img src={require("../imgs/printmaking/Light_state22.jpg")} style={{width:'100%'}} />
